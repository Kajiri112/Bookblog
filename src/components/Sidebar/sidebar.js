        ...
        <div className="sidebarCard">
          ...
          <div className="cardBody">
            <p className="personalBio">
              Lisa, 30, ich liebe Bücher und Manga und die japanische Kultur.
              Wenn ich nicht gerade in meinem Lesesessel schmökere und Kaffee
              trinke, vereise ich mit meiner Kamera.
            </p>
          </div>
        </div>
      </Card>
      ...
      <Card className="sidebarCard">
        <div className="sidebarCard">
          ...
          <div className="socialMedia">
            <a href="https://www.instagram.com/kajiji/">
